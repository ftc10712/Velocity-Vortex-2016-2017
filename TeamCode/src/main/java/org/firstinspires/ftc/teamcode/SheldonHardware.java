...
public class SheldonHardware {
    ...
    public Servo    leftForkGripperServo    = null;
    public Servo    rightForkGripperServo   = null;

    /* Define variables for Mast Horizontal Movement Servos and initialize them to null */
    public Servo    leftMastHorizontalMovementServo     = null;
    public Servo    rightMastHorizontalMovementServo    = null;
